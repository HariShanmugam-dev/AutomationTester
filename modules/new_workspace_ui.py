...
################################################################################
## Form generated from reading UI file 'new_workspace.ui'
##
...
class Ui_newWorkspaceWindow(object):
    def setupUi(self, newWorkspaceWindow):
        ...
        newWorkspaceWindow.setWindowModality(Qt.WindowModality.ApplicationModal)
        newWorkspaceWindow.resize(720, 650)
        newWorkspaceWindow.setMinimumSize(QSize(720, 650))
        newWorkspaceWindow.setMaximumSize(QSize(720, 650))
...
"")
        ...
        self.txt_projectName.setMinimumSize(QSize(360, 30))
        ...
        self.txt_projectLocationPath.setMinimumSize(QSize(360, 30))
...
"}")
        ...
        self.txt_targetAppPath.setMinimumSize(QSize(360, 30))
        ...
        self.txt_reportsPath.setMinimumSize(QSize(360, 30))
        ...
        self.txt_setupScriptPath.setMinimumSize(QSize(360, 30))
    ...
    def retranslateUi(self, newWorkspaceWindow):
        newWorkspaceWindow.setWindowTitle(QCoreApplication.translate("newWorkspaceWindow", u"Form", None))
