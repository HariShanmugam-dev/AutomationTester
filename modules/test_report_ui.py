...
"}")
        ...
        self.gridLayout = QGridLayout(self.contentTopBg)
        ...
        self.gridLayout.addWidget(self.winTtile, 0, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.tabButtons, 0, 1, 1, 1)

        self.bgApp = QFrame(self.contentTopBg)
...
"}")
        ...
        sizePolicy2.setHeightForWidth(self.lbl_TestReport.sizePolicy().hasHeightForWidth())
        self.lbl_TestReport.setSizePolicy(sizePolicy2)
        font2 = QFont()
        font2.setFamilies([u"Segoe UI"])
        font2.setPointSize(15)
        font2.setBold(False)
        font2.setItalic(False)
        self.lbl_TestReport.setFont(font2)
        ...
        sizePolicy2.setHeightForWidth(self.lbl_elapsedTime.sizePolicy().hasHeightForWidth())
        self.lbl_elapsedTime.setSizePolicy(sizePolicy2)
        ...
        sizePolicy3.setHeightForWidth(self.txt_elapsedTime.sizePolicy().hasHeightForWidth())
        self.txt_elapsedTime.setSizePolicy(sizePolicy3)
        ...
        sizePolicy2.setHeightForWidth(self.txt_Failed.sizePolicy().hasHeightForWidth())
        self.txt_Failed.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.txt_Passed.sizePolicy().hasHeightForWidth())
        self.txt_Passed.setSizePolicy(sizePolicy2)
        ...
        sizePolicy2.setHeightForWidth(self.txt_Blocked.sizePolicy().hasHeightForWidth())
        self.txt_Blocked.setSizePolicy(sizePolicy2)
        ...
        self.gridLayout.addWidget(self.bgApp, 1, 0, 1, 2)


        self.gridLayout_5.addWidget(self.contentTopBg, 0, 0, 1, 1)
